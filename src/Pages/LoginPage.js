            ...
            <Container style={{padding: 350}}>
                <Form>
                    <FormGroup>
                        ...
                        <Form.Control className={"mt-2"} placeholder="wprowadź login" value={username}
                                      onChange={text => setUsername(text.target.value)}/>
                        <Form.Control type="password" className={"mt-2"} placeholder="wprowadź hasło" value={password}
                                      onChange={text => setPassword(text.target.value)}/>
                        {notCorrect ?
                            <Form.Text style={{color: "red"}}>wprowadzono niepoprawne dane logowania</Form.Text> : null}
                        <Button style={{width: 440}} variant={"success"} className={"mt-2"}
